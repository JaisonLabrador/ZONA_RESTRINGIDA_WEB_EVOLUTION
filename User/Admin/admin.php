                ...
                <div class="navbar-collapse collapse">
                    <div class="menu">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation"><a href="" class="active">Services</a></li>
    ...
    <footer>
        <div class="container">
            <div class="col-md-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                <h4>About Us</h4>
                <p>Jaison Damian Labrador Suarez - Desarrollador Web</p>
                <div class="contact-info">
                    <ul>
                        <li><i class="fa fa-home fa"></i> Soatá - Boyacá </li>
                        <li><i class="fa fa-phone fa"></i> +57 314 226 79 28</li>
                        <li><i class="fa fa-envelope fa"></i> labradorjaison@gmail.com</li>
                    </ul>
                </div>
            </div>
    ...
    <div class="sub-footer">
        <div class="container">
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="copyright">
                    &copy; JaisonLabrador. All Rights Reserved.
                </div>
            </div>
        </div>
    </div>
